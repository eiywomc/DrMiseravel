...
public class FXMLReceitaController {
	...
	@FXML
	public void loadCadastrarReceita(ActionEvent event) {
		// TODO Autogenerated
	}
	// Event Listener on Button[#btnConsultar].onAction
	@FXML
	public void loadConsultarReceita(ActionEvent event) {
		// TODO Autogenerated
	}
	// Event Listener on Button[#btnAtualizar].onAction
	@FXML
	public void loadAtualizarReceita(ActionEvent event) {
		// TODO Autogenerated
	}
	// Event Listener on Button[#btnExcluir].onAction
	@FXML
	public void loadExcluirReceita(ActionEvent event) {
		// TODO Autogenerated
	}
	// Event Listener on Button[#btnConsultarTodos].onAction
	@FXML
	public void loadConsultarTodosReceitas(ActionEvent event) {
		// TODO Autogenerated
	}
}
